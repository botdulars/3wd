...
void wheelSpin()
{
    ...
    BTSerial.println("spinning wheels clockwise and anti clockwise for 2 seconds! Keep them raised so they dont run away :)");
...
void turnONGreenLED() 
{
    ...
    BTSerial.println("This instruction turns the green LED ON for 1 sec") ; 
    delay(1000); 
